...
const int64_t nBlockSequentialAlgoRuleStart = 360000; // block where sequential algo rule starts
const int nBlockSequentialAlgoMaxCount = 3; // maximum sequential blocks of same algo
const int64_t nBlockTimeWarpPreventStart = 360000; // block where time warp prevention starts
const int64_t nBlockDiffAdjustV3 = 360000; // block where difficulty adjust V2 starts
