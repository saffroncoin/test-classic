...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel2->setText(QStringLiteral("Copyright &copy; 2013 The Saffroncoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Saffroncoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Saffroncoin</b> version", 0));
